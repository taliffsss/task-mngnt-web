  ...
  return (
    <div className="flex items-center justify-center h-screen">
        <div className="bg-white p-8 rounded-lg shadow-md w-96">
            ...
            <Formik initialValues={data.loginPayload} validationSchema={loginSchema} onSubmit={onSubmit}>
              {({ isSubmitting, values, errors, touched, handleChange, resetForm, setFieldValue, setFieldTouched }) => (
                <Form>
                  <div className="mb-4">
                      ...
                      <Field 
                          ...
                          className={`mt-1 p-2 w-full border rounded-md ${errors.email && touched.email ? 'border-red-500' : ''}`}
                      />
